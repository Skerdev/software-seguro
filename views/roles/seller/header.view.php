    ...
    <main class="full-box main-container">
        ...
        <section class="full-box nav-lateral">
            ...
            <div class="full-box nav-lateral-content">
                ...
                <nav class="full-box nav-lateral-menu" aria-label="Profile options">
                    <ul>
                        <li>
                ...
                <nav class="full-box nav-lateral-menu" aria-label="Main navigation">
                    <ul>
                        <li>
        ...
        <section class="full-box page-content">
            <nav class="full-box navbar-info" aria-label="Barra de navegación">
